...
constexpr uint8_t LcdBacklightPwmChannel = 7;
constexpr uint32_t LcdBacklightPwmFrequency = 5000;
constexpr uint8_t LcdBacklightPwmResolutionBits = 8;
constexpr uint8_t LcdBacklightFullPercent = 100;
constexpr uint8_t LcdBacklightDimPercent = 25;
...
constexpr uint32_t UsagePeekDurationMs = 10000;
constexpr uint32_t WaitingUsagePeekDelayMs = 5000;
constexpr uint32_t BootingScreenMs = 8000;
constexpr uint32_t SerialDisconnectTimeoutMs = 300000;
constexpr uint32_t EyeExpressionIntervalMinMs = 3500;
constexpr uint32_t EyeExpressionIntervalMaxMs = 8000;
constexpr uint32_t IdleSleepDelayMs = 45000;
constexpr uint32_t LcdDimAfterIdleMs = 120000;
constexpr uint32_t LcdOffAfterIdleMs = 600000;
constexpr uint32_t DeviceStatusIntervalMs = 10000;
